...
#pygame.mixer.music.load("[Songs.PK] Unchained Melodies Encore - 07 - Iktara (Wake Up Sid!).mp3")
...
snakex=700
snakey=100
ladder=pygame.image.load("ladder1.jpg")
ladderx=700
laddery=100
def getc(n):
    if(n<=10 and n>=1):
...
def check1(p):
    if(p==16 or p==31 or p==47 or p==63 or p==66 or p==97):
        pygame.draw.rect(setDisplay,black,(700,100,700,700))
